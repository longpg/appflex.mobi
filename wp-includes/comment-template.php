...
?>
		...
		<?php endif; ?>
		<div class="blocks_list_cmt">
		<span class="blocks_list_cm">
		<?php printf(__('<span class="name"><img border="0" style="width: 12px;" src="http://taigamehot.mobi/comment.png">%s</span>:'),get_comment_author_link()) ?>
		<span class="content"><?php echo $comment->comment_content;?></span>
		</span>
		</div>
