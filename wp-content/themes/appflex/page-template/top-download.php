...
<div id="tabmenu">
    <ul class="individual">
        ...
        <li  class="selected"><a href="http://appflex.mobi/top-downloads"><span>Tải nhiều</span></a></li>
    </ul>
</div>
		<?php if ( have_posts() ) : ?>
				<div class="list-app">
						<?php 
							$page = ( get_query_var( 'paged' ) ) ? get_query_var( 'paged' ) : 1;
								$total = countPostIDFilterFileHits();
								// Calculate Paging
								$numposts = $total;
								$perpage = 10;
								...
								if($max_page > 1) {
									...
									$output .= '<span class="pages">&#8201;'.sprintf(__('Trang', 'nqd-store'), number_format_i18n($page), number_format_i18n($max_page)).'&#8201;</span>';
							...
							$post_ID = getPostIDFilterFileHits($offset,$perpage);			
						?>
						<?php 
